...
use constant FILE_SQL_GAME_DELETE							=> 'sql/User/Game/delete.sql';
use constant FILE_SQL_GAME_DELETE_FROM_PID					=> 'sql/User/Game/deleteFromPID.sql';
...
use constant FILE_SQL_GAMEACCOUNT_DELETE					=> 'sql/User/GameAccount/delete.sql';
use constant FILE_SQL_GAMEACCOUNT_DELETE_FROM_GID			=> 'sql/User/GameAccount/deleteFromGID.sql';
use constant FILE_SQL_GAMEACCOUNT_DELETE_FROM_UID			=> 'sql/User/GameAccount/deleteFromUID.sql';
...
use constant FILE_SQL_GAMEACCOUNT_RIVAL_DELETE				=> 'sql/User/GameAccount/Rival/delete.sql';
use constant FILE_SQL_GAMEACCOUNT_RIVAL_DELETE_FROM_GAID	=> 'sql/User/GameAccount/Rival/deleteFromGAID.sql';
use constant FILE_SQL_GAMEACCOUNT_RIVAL_INSERT				=> 'sql/User/GameAccount/Rival/insert.sql';
use constant FILE_SQL_GAMEACCOUNT_RIVAL_SELECT_FROM_ID		=> 'sql/User/GameAccount/Rival/select.sql';
use constant FILE_SQL_GAMEACCOUNT_RIVAL_SELECT_FROM_ID_BOTH	=> 'sql/User/GameAccount/Rival/selectFromBothID.sql';
use constant FILE_SQL_GAMEACCOUNT_RIVAL_UPDATE				=> 'sql/User/GameAccount/Rival/update.sql';
