...
INSERT INTO DIR_USER_ACCOUNT (ID, PASSWD, REGIST_TIME, LOGIN_TIME) VALUES (1, 'raXrEvi4ffDyNnsVwVnWivkmzuY', '1999-05-01 00:00:00', NOW());
...
CREATE TABLE IF NOT EXISTS DIR_USER_ADDITIONAL(
	...
	NOTES			TEXT									COMMENT '備考',
	FOREIGN KEY (USER_ID) REFERENCES DIR_USER_ACCOUNT(ID) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT = 'ユーザマスターアカウントの付加情報';

INSERT INTO DIR_USER_ADDITIONAL (USER_ID, NICKNAME, INTRODUCTION, RENEW_TIME) VALUES (1, 'まく', 'danmaq', NOW());

CREATE TABLE DIR_PUBLISHER(
	ID			SMALLINT UNSIGNED					PRIMARY KEY AUTO_INCREMENT	COMMENT 'パブリッシャーID',
	USER_ID		INTEGER UNSIGNED					NOT NULL UNIQUE				COMMENT 'ユーザID',
...
INSERT INTO DIR_PUBLISHER (USER_ID, CO_NAME, HEAD_NAME, URL, COMMISSION, REGIST_TIME) VALUES (1, 'danmaq', '野村 周平', 'http://danmaq.com/', 255, '1999-05-01 00:00:00');

CREATE TABLE DIR_GAME(
	ID			SMALLINT UNSIGNED					PRIMARY KEY AUTO_INCREMENT	COMMENT 'ゲームID',
	PUB_ID		SMALLINT UNSIGNED					NOT NULL					COMMENT 'パブリッシャーID',
	...
	REGIST_TIME	TIMESTAMP							NOT NULL					COMMENT '登録日時',
	NOTES		TEXT															COMMENT '備考',
	FOREIGN KEY (PUB_ID) REFERENCES DIR_PUBLISHER(ID) ON UPDATE CASCADE ON DELETE CASCADE
